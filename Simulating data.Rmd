...
Not sure either but how do you get rid of the negative RT in the original RT variable? Maybe you're adding the same value to a bunch of RTs and that's why?
```{r}
