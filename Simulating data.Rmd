...
wh_w <- wh_split %>% 
  ...
  filter(word %in% c("WAS", "WE", "WERE", "ONE", "WITH", "WELL", "WAY", "WENT", "WOULD", "ALWAYS", "WINTER", "WASN'T", "WOOD", "QUITE", "WORK", "WARTER", "ONCE", "WE'RE", "WOULDN'T", "WILL"))
...
wh_syn <- syn(wh_small, maxfaclevels = 110)
